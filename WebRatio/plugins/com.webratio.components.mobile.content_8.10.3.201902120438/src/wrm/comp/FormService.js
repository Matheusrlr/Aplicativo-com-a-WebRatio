...
export default wrm.defineService(wrm.core.AbstractViewComponentService, {
        ...
        this._fields.forEach(function(field) {
            ...
            case "SelectionField":
                ...
                if (refreshMode === RefreshMode.PRESERVE) {
                    ...
                    options = thisService._computeSelectionFieldOptions(context, field, refreshMode, hasFreshOptionsInputs,
                            sFieldLabels, sFieldOutputs);
    ...
    _computeSelectionFieldPreselection: function(context, field, refreshMode) {
        ...
        if (!field[Tags.SPLITOUTPUT.LABEL]) { // splitOutput == false means that value property of option object is
            // exactly what I'm looking for
            return input[fieldId + Tags.PRESEL.SUFFIX] || field["preselectValue"];
        } else { // splitOutput == true means that value property of option object is an object
