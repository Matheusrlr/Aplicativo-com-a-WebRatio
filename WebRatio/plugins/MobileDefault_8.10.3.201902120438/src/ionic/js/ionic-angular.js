/*!
 * @license Copyright 2015 Drifty Co.
 * http://drifty.com/
 *
 * Ionic, v1.3.5
...
function CollectionRepeatDirective($ionicCollectionManager, $parse, $window, $$rAF, $rootScope, $timeout) {
  ...
  function postLink(scope, element, attr, scrollCtrl, transclude) {
    ...
    scope.$on('$destroy', function() {
      ...
      angular.element(computedStyleNode).remove(); // WR bug 9793
  ...
  return ['$ionicScrollDelegate', function($ionicScrollDelegate) {
    return {
      ...
      link: function($scope, $element, $attr) {
        ...
        //});
        var dereg = ionic.onGesture('tap', onTap, $element[0]);
        $scope.$on('$destroy', function () {
          ionic.offGesture(dereg, 'tap', onTap);
          $element[0].removeEventListener('touchstart', onTap);
          dereg.element = null;
          dereg = onTap = null;
        });
        /* WR end */
