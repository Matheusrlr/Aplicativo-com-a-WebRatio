...
},{"./core.$for":28,"./core.array.turn":29,"./core.binding":30,"./core.date":31,"./core.delay":32,"./core.dict":33,"./core.global":34,"./core.iter-helpers":35,"./core.log":36,"./core.number.iterator":37,"./core.number.math":38,"./core.object":39,"./core.string.escape-html":40,"./es5":41,"./es6.array.copy-within":42,"./es6.array.fill":43,"./es6.array.find":45,"./es6.array.find-index":44,"./es6.array.from":46,"./es6.array.iterator":47,"./es6.array.of":48,"./es6.array.species":49,"./es6.function.name":50,"./es6.map":51,"./es6.math":52,"./es6.number.statics":53,"./es6.object.assign":54,"./es6.object.is":55,"./es6.object.set-prototype-of":56,"./es6.object.statics-accept-primitives":57,"./es6.object.to-string":58,"./es6.promise":59,"./es6.reflect":60,"./es6.set":61,"./es6.string.code-point-at":62,"./es6.string.ends-with":63,"./es6.string.from-code-point":64,"./es6.string.includes":65,"./es6.string.iterator":66,"./es6.string.raw":67,"./es6.string.repeat":68,"./es6.string.starts-with":69,"./es6.symbol":70,"./es6.weak-map":71,"./es6.weak-set":72,"./es7.array.includes":73,"./es7.object.get-own-property-descriptors":74,"./es7.object.to-array":75,"./es7.regexp.escape":76,"./es7.set.to-json":77,"./es7.string.at":78,"./js.array.statics":79,"./web.dom.iterable":80,"./web.immediate":81,"./web.timers":82}],2:[function(require,module,exports){
'use strict';
// false -> Array#indexOf
// true  -> Array#includes
var $ = require('./$');
...
},{"./$.assign":5,"./$.def":11}],55:[function(require,module,exports){
...
},{"./$.def":11}],56:[function(require,module,exports){
// 19.1.3.19 Object.setPrototypeOf(O, proto)
var $def = require('./$.def');
$def($def.S, 'Object', {setPrototypeOf: require('./$.set-proto').set});
},{"./$.def":11,"./$.set-proto":21}],57:[function(require,module,exports){
var $        = require('./$')
  , $def     = require('./$.def')
  , isObject = $.isObject
  , toObject = $.toObject;
...
},{"./$":16,"./$.cof":6,"./$.wks":27}],59:[function(require,module,exports){
'use strict';
var $       = require('./$')
  , ctx     = require('./$.ctx')
  , cof     = require('./$.cof')
...
},{"./$":16,"./$.assert":4,"./$.cof":6,"./$.ctx":10,"./$.def":11,"./$.iter":15,"./$.iter-detect":14,"./$.species":22,"./$.task":24,"./$.uid":25,"./$.wks":27}],60:[function(require,module,exports){
var $         = require('./$')
  , $def      = require('./$.def')
...
},{"./$":16,"./$.assert":4,"./$.ctx":10,"./$.def":11,"./$.iter":15,"./$.own-keys":18,"./$.set-proto":21,"./$.uid":25}],61:[function(require,module,exports){
'use strict';
var strong = require('./$.collection-strong');
...
},{"./$.collection":9,"./$.collection-strong":7}],62:[function(require,module,exports){
var $def = require('./$.def');
$def($def.P, 'String', {
  // 21.1.3.3 String.prototype.codePointAt(pos)
  codePointAt: require('./$.string-at')(false)
});
},{"./$.def":11,"./$.string-at":23}],63:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , cof  = require('./$.cof')
  , $def = require('./$.def')
...
},{"./$":16,"./$.cof":6,"./$.def":11}],64:[function(require,module,exports){
var $def    = require('./$.def')
...
},{"./$":16,"./$.iter":15,"./$.string-at":23,"./$.uid":25}],67:[function(require,module,exports){
var $    = require('./$')
  , $def = require('./$.def');
...
},{"./$":16,"./$.def":11}],68:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , $def = require('./$.def');
...
},{"./$":16,"./$.def":11}],69:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , cof  = require('./$.cof')
  , $def = require('./$.def');
...
},{"./$":16,"./$.cof":6,"./$.def":11}],70:[function(require,module,exports){
'use strict';
...
},{"./$":16,"./$.cof":6,"./$.def":11,"./$.keyof":17,"./$.uid":25,"./$.wks":27}],71:[function(require,module,exports){
'use strict';
var $         = require('./$')
...
},{"./$":16,"./$.collection":9,"./$.collection-weak":8}],72:[function(require,module,exports){
'use strict';
...
},{"./$.collection":9,"./$.collection-weak":8}],73:[function(require,module,exports){
...
},{"./$.array-includes":2,"./$.def":11,"./$.unscope":26}],74:[function(require,module,exports){
...
},{"./$":16,"./$.def":11,"./$.own-keys":18}],75:[function(require,module,exports){
// http://goo.gl/XkBrjD
var $    = require('./$')
  , $def = require('./$.def');
...
},{"./$":16,"./$.def":11}],76:[function(require,module,exports){
// https://gist.github.com/kangax/9698100
var $def = require('./$.def');
$def($def.S, 'RegExp', {
  escape: require('./$.replacer')(/([\\\-[\]{}()*+?.,^$|])/g, '\\$1', true)
});
},{"./$.def":11,"./$.replacer":20}],77:[function(require,module,exports){
...
},{"./$.def":11,"./$.iter":15}],78:[function(require,module,exports){
// https://github.com/mathiasbynens/String.prototype.at
var $def = require('./$.def');
$def($def.P, 'String', {
  at: require('./$.string-at')(true)
});
},{"./$.def":11,"./$.string-at":23}],79:[function(require,module,exports){
...
},{"./$":16,"./$.ctx":10,"./$.def":11}],80:[function(require,module,exports){
require('./es6.array.iterator');
var $         = require('./$')
...
},{"./$":16,"./$.iter":15,"./$.wks":27,"./es6.array.iterator":47}],81:[function(require,module,exports){
var $def  = require('./$.def')
  , $task = require('./$.task');
$def($def.G + $def.B, {
...
},{"./$.def":11,"./$.task":24}],82:[function(require,module,exports){
